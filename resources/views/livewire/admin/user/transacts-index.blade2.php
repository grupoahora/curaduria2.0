<div class="container-fluid border border-dark p-0 m-0">
    ...
    <!-- 1.3 Modalidad licencia de urbanizacion
         1.4 Modalidad licencia subdivisión
        ...
        <div class="col-6">
            <div class="card border border-dark">
                ...
                <div class="card-body">
                    <div class="row justify-content-md-top">
                            <div class="col-10">
                                A. OBRA NUEVA *Dilicenciar en el numeral 1.10 las medidas de construcción sostenible a implementar.*
                            </div>
                            <div class="col-2">
                                <div class="checkbox justify-content-md">
                                    <label><input type="checkbox" value=""></label>
                ...
                <div class="card-body">
                    <div class="row justify-content-md-top form-group">
                        ...
                        <div class="col-4">
                            <div class="row justify-content-md-top">
                                <div class="col-8">
                                    Alcanza o supera mediante ampliación los 2.000 m²
                                </div>
                                <div class="col-2">
                                    <div class="checkbox justify-content-md">
                                        <label><input type="checkbox" value=""></label>
    ...
    <!-- 1.10 Reglamentación de construcción sostenible
         1.10.1 Declaración sobre medidas de construcción sostenible
         1.10.2 Zonificación climática
         -->
    <div class="row justify-content-md-top form-group">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header text-center p-0 m-0">
                    <div class="row justify-content-md-top form-group p-0 m-0">
                        <div class="col-6 border border-dark p-0 m-0">
                                <h6 class=" font-weight-bold border-bottom border-dark py-auto my-auto">1.10.1 DECLARACIÓN SOBRE MEDIDAS DE CONSTRUCCIÓN SOSTENIBLE</h6>
                                <div class="card-body">
                                    <div class="row justify-content-md-top form-group">
                                        <div class="col-4">
                                                <div class="row justify-content-md-top">
                                    ...
                                    <div class="row justify-content-md-top form-group">
                                        <h6 class="small font-weight-bold font-italic">
                                            El señalar cualquiera de estas casillas, no implica
                                            la presentación de documentos adicionales para el trámite
                                            de la licencia.
                                        </h6>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 border border-dark p-0 m-0">
                                <h6 class=" font-weight-bold border-bottom border-dark py-2 my-auto">1.10.2 ZONIFICACIÓN CLIMÁTICA</h6>
                                <div class="card-body">
                                    <div class="row justify-content-md-top form-group">
                                        <h6 class="small font-weight-bold">
                                            Señale la zona Climática asignada de acuerdo al Anexo 2
                                            de la Res. 549 de 2015.
                                        </h6>
                                    </div>
                                    <div class="row justify-content-md-top form-group">
                                        <div class="col-3">
                                    ...
                                    <div class="row justify-content-md-top form-group">
                                        <h6 class="small font-weight-bold">
                                            ¿Su predio se encuentra en una zona climática distina a la que le fue asignada?
                                        </h6>
                                    </div>
                                    <div class="row justify-content-md-top form-group">
                                        <div class="col-6">
    ...
    <div class="row justify-content-md-top form-group">
        <div class="col-12">
            <div class="card">
                <div class="card-header border border-dark bg-secondary">
                    <h5 class="text-left font-weight-bold">
                        2. IDENTIFICACIÓN SOBRE EL PREDIO
                    </h5>
                    <h6 class="text-left font-italic">
                        (Marcar con una X en la casilla correspondiente y llenar los espacios con letra imprenta)
                    </h6>
                </div>
                        ...
                        <div class="col-6 p-0 m-0">
                            <div class="card p-0 m-0 border border-dark">
                                <div class="card-header border-dark">
                                    ...
                                    <h5>
                                    <h6 class="text-left px-1 mx-1">
                                        ACTUAL
                                    <h6>
                                </div>
                                <div class="card-body px-0 mx-0">
                                    <textarea class="form-control border-0" placeholder="______________________________________________________________________________________________________________________________________________________________________________" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 p-0 m-0">
                            <div class="card p-0 m-0 border border-dark">
                                <div class="card-header border-dark">
                                    <h6 class="text-left px-1 mx-1 py-3">
                                        ANTERIOR(ES)
                                    <h6>
                                </div>
                                <div class="card-body px-0 mx-0 py-auto my-0">
                                    <textarea class="form-control border-0" placeholder="______________________________________________________________________________________________________________________________________________________________________________" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-md-top form-group p-0 m-0">
                        <div class="col-6 p-0 m-0">
                            <div class="card p-0 m-0 border border-dark">
                                ...
                                <div class="card-body px-0 mx-0">
                                    <textarea class="form-control border-0" placeholder="____________________________________________________________________________________________________________________" rows="2"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 p-0 m-0">
    ...
    <div class="row justify-content-md-top form-group">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body border border-dark p-0 m-0">
                    <div class="row p-0 m-0">
                        <div class="col-2 border-right border-dark font-weight-bold">
                            URBANIZADOR O CONSTRUCTOR RESPONSABLE
                            <h6 class="small">
                                (Para constructor responsable experiencia mínima 3 años o posgrado)
                            </h6>
                        </div>
                        <div class="col-10 border-left border-dark">
                            ...
                            <div class="row border-bottom border-top border-dark">
                                ...
                                <div class="col-5 border-right border-left border-dark">
                                    <div class="row text-left">
                                        <div class="col-4">
                ...
                <div class="card-body border border-dark p-0 m-0">
                    <div class="row p-0 m-0">
                        <div class="col-2 border-right border-dark font-weight-bold">
                            ...
                            <h6 class="small">
                                (Experiencia mínima de 5 años o posgrado)
                            </h6>
                        </div>
                        <div class="col-10 border-left border-dark">
                            <div class="row pb-0">
                                <div class="col-10 pr-0">
                                    ...
                                    <div class="row border-bottom border-top border-dark">
                                        ...
                                        <div class="col-4 border-left border-right border-dark">
                                            <div class="row text-left">
                                                <div class="col-6">
                                                    FECHA EXP. MATRICULA
                                                </div>
                                ...
                                <div class="col-2 pt-0 pb-0">
                                    <div class="row border-left border-dark p-0 m-0">
                                        <h6 class="small">
                                            Establece que es necesaria la Supervisión Técnica
                                        </h6>
                                    </div>
                                    <div class="row border-left border-dark p-0 m-0">
                                        <div class="col-6">
                ...
                <div class="card-body border border-dark p-0 m-0">
                    <div class="row p-0 m-0">
                        <div class="col-2 border-right border-dark font-weight-bold">
                            ...
                            <h6 class="small">
                                (Experiencia mínima de 3 años o posgrado)
                            </h6>
                        </div>
                        <div class="col-10 border-left border-dark">
                            <div class="row pb-0">
                ...
                <div class="card-body border border-dark p-0 m-0">
                    <div class="row p-0 m-0">
                        <div class="col-2 border-right border-dark font-weight-bold">
                            INGENIERO TOPÓGRAFO Y/O TOPÓGRAFO
                        </div>
                        <div class="col-10 border-left border-dark">
                            <div class="row border-bottom border-dark">
                                <div class="col-6 border-right border-dark">
