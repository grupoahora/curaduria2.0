                ...
                <form>
                    <div class="row my-2">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label>Numero de C.C.</label>
                                <input type="number" class="form-control" placeholder="Cedula de Ciudadanía ...">
                            </div>
                        </div>
                    ...
                    <div class="row my-2">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label>Motivo</label>
                                <textarea class="form-control" rows="5" placeholder="Describe la situacion por la cual nos contactas..."></textarea>
                            </div>
                        </div>
