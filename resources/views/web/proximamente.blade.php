...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <title>Curaduría Urbana 2</title>
        ...
        <link href="prox/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
        <link href="prox/vendor/themify/themify.css" rel="stylesheet" type="text/css"/>
        <link href="prox/vendor/scrollbar/scrollbar.min.css" rel="stylesheet" type="text/css"/>

        <!-- Theme Styles -->
        <link href="prox/css/style.css" rel="stylesheet" type="text/css"/>
        <link href="prox/css/global/global.css" rel="stylesheet" type="text/css"/>

        <!-- Favicon -->
        <link rel="shortcut icon" href="prox/img/favicon.ico" type="image/x-icon">
        <link rel="apple-touch-icon" href="prox/img/apple-touch-icon.png">
    </head>
    <!-- End Head -->
    ...
    <body>
                        ...
                        <div class="s-header__navbar-row-col">
                            ...
                            <div class="s-header__logo">
                                <a href="/" class="s-header__logo-link">
                                    <img class="s-header__logo-img logo" src="prox/img/Logo.png" alt="Megakit Logo">
                                </a>
                            </div>
                            <!-- End Logo -->
                        </div>
        ...
        <!--========== PAGE CONTENT ==========-->
        <div class="g-bg-position--center g-fullheight--xs" style="background: url('prox/img/1920x1080/08.jpg');">
            <div class="container js__ver-center-aligned">
                <div class="g-text-center--xs">
                    <div class="g-margin-t-40--xs g-margin-b-60--xs g-margin-b-80--sm">
                        <h1 class="g-font-size-26--xs g-font-size-35--sm g-font-size-60--md g-margin-b-30--xs fw-bold ">Curaduria Urbana<img class="img-fluid img-profile  mx-auto  image image-sm" src="prox/img/roman_numeral_icon_135243.png" alt="..." />Próximamente nuevo sitio Web</h1>

                        <p class="text-uppercase g-font-size-20--md g-font-weight--300 ">Se recuerda a todos los usuarios que el único correo electrónico habilitado para recepción de derechos de petición es: <h1 class="g-font-size-16--xs g-font-size-25--sm g-font-size-30--md g-margin-b-30--xs ">CONTACTO@CURADURIADOSCUCUTA.COM</h1> </p>
                    </div>
                    <form>
                        <div class="row g-margin-b-80--xs">
                            <div class="col-sm-4 col-sm-offset-2 col-xs-6 g-full-width--xs g-margin-b-30--xs g-margin-b-0--md">
                                <div class="input-group index-3">
                                    <span class="input-group-btn">
                                        <i class="s-form-v4__icon ti-user"></i>
                                    </span>
                                    <input type="text" class="form-control s-form-v4__input  rounded-3" placeholder="Tú Nombre">
                                  <!--   <label for="name" class="index-3  fs-3">Nombre</label> -->
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-6 g-full-width--xs">
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control s-form-v4__input  rounded-3" placeholder="Tú Correo">
                                  <!--   <label for="email" class="index-3  fs-3">Correo</label> -->
                                </div>
                            </div>
                        </div>
        ...
        <!-- Vendor -->
        <script type="text/javascript" src="prox/vendor/jquery.min.js"></script>
        <script type="text/javascript" src="prox/vendor/jquery.migrate.min.js"></script>
        <script type="text/javascript" src="prox/vendor/bootstrap/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="prox/vendor/jquery.smooth-scroll.min.js"></script>
        <script type="text/javascript" src="prox/vendor/scrollbar/jquery.scrollbar.min.js"></script>

        <!-- General Components and Settings -->
        <script type="text/javascript" src="prox/js/global.min.js"></script>
        <script type="text/javascript" src="prox/js/components/scrollbar.min.js"></script>
        <!--========== END JAVASCRIPTS ==========-->
